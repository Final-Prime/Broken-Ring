...
## 2. Form mirrors content ("loop" sentences)

Syntactic iconicity: the shape of the sentence enacts the thing it
...
the sentence's own structure can perform that quality rather than just
assert it. Treat this as a default question to ask, not a lucky accident
to wait for.
